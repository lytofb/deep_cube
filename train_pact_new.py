...
config = OmegaConf.load("config_pact.yaml")
...
def transform_src_tgt(src, tgt):
    """
    将 src 和 tgt 按要求转换：
    src: tensor of shape (B, src_seq_len, 55)
    tgt: tensor of shape (B, tgt_seq_len - 1)

    要求是输出 out, 形状为 (B, src_seq_len, 1)
